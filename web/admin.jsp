...
<%
    String admin = null;
    try {
        admin = (String) session.getAttribute("adminname");
    } catch (Exception e) {
    }
%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="margin:0px 0px 0px 0px">
        <%
            String adminna = null;
            try {
                adminna = (String) session.getAttribute("adminname");
                if (adminna == null) {
            ...
            <tr>
                <td colspan="2">
                    <ul class="glossymenu">
                        ...
                        <li><a href="upload.jsp"><b>Upload Video</b></a></li>
                ...
                <td width="800px" style="vertical-align:top">
                    ...
                    <form name="admin" method="post"  action="" >
                        <table border="1" align="center" width="80%">
                            <tr>
                                <td>
                                    <h1 style="color:#060" align="center">Admin Panel</h1>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <table border="0" align="center">
                                        <tr>
                                            <td align="center"><h3><a href="category.jsp">Category</a></h3><hr /></td>
                                        </tr>
                                        <tr>
                                            <td  align="center"><h3><a href="userdetail.jsp">Userinfo</a></h3><hr /></td>
                                        </tr>
