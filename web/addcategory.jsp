        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                <td width="800px" style="vertical-align:top">
                    ...
                    <form name="addcategory" method="post"  action="addcategory.jsp" >
                        <table border="30" align="left" style="margin-left:400px; margin-top:120px">
                            <tr>
                                <td>
                                    <table border="0" align="center">

                                        <tr>
                                            <td><div style=" background-color:#090; border:outset;  height:30px; padding-top:10px"><font color="#FFFFFF" size="+1"><b>Add Category</b></font></div></td>
                                        </tr>
                                        <tr>
                                            <td ><input name="categoryadd"  type="text" value="" class="tb5"/><br /></td>
                                        </tr>

                                        <tr>
                                            <td colspan="2" align="right"><input type="submit" name="insert" value="Add" class="myButton3"/></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                    ...
                    <%
                        ...
                        //out.println("button value is:"+insert);
                        if (insert != null) {
                            //out.println("hi");
                            String categoryadd = request.getParameter("categoryadd");
                            //out.println("category value is:"+categoryadd);
                            if (categoryadd.compareTo("") != 0) {
                                out.println("</td><tr><td>");
                                //out.println("category is written");
                                String sql = "insert into v_category(categoryname)values('" + categoryadd + "')";
                                stmt8.executeUpdate(sql);
                    %>
                    <h3 style="margin-left:20px; color:#090">Successfully inserted Category</h3>
                    <%
                            }
                        }
                    %>
                ...
                <td style="vertical-align:top"> 
                    <div style="float:right;margin:10px 5px 0px 0px">
                        <form method="post" action="index.jsp">
                          ...
                          <table border="0" id="table" cellpadding="5px" cellspacing="0" style="border-left: 0px solid rgb(249, 119, 32); border-right: 0px solid rgb(174, 166, 151); border-bottom: 0px solid rgb(249, 119, 32); margin-top: -330px; margin-bottom: 0px;">      
                          <tr>
