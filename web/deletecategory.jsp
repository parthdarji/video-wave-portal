                ...
                <td width="800px" style="vertical-align:top">
                    ...
                    <%
                        ...
                        if (category != null && category.compareTo("") != 0) {
                            String sqr = "delete from v_category where categoryname='" + category + "'";
                            //out.println(sql);
                            stmt11.executeUpdate(sqr);
                    %>
                    <h3 style="margin-left:20px; color:#090">Successfully Deleted Category</h3>
                    <%
                        }
                    %>	
                    <form name="addcategory" method="post"  action="deletecategory.jsp" >
                        <table border="0" align="center">
                            <tr>
                                <td>
                                    <table border="30" align="center" style="margin-left:400px; margin-top:130px">

                                        <tr>
                                            <td><div style=" background-color:#090; border:outset;  height:30px; padding-top:10px"><font color="#FFFFFF" size="+1"><b>Delete Category</b></font></div></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="dropdown">
                                                    <select name="categorydelete" value="" class="dropdown-select">
                                                        <%
                                                            String sql2 = "select * from v_category";
                                                            ResultSet rs1 = stmt10.executeQuery(sql2);
                                                            while (rs1.next()) {
                                        ...
                                        <tr>
                                            <td colspan="2" align="right"><input type="submit" name="delete" value="Delete" class="myButton3" /></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
